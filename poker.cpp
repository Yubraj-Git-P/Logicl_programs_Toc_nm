...
int main() {
    ...
    // Variables for 4-digit poker test
    ...
    switch(num) {
        case 2: // Four digit poker test
            ...
            if ((four_diff + four_of_a_kind + three_of_a_kind + one_pair + two_pair) != n) {
                ...
                for(i = 0; i < 5; i++) {
                    CAL_CHISQUARE += ((observed_frequency_4d[i] - expected_frequency_4d[i]) *
                ...
                printf("\nThe tabulated value for chi-square is %f", TAB_CHISQUARE_4D);
        ...
        case 1: // Three digit poker test
            ...
            if ((three_diff + three_of_a_kind + one_pair) != n) {
                ...
                for(i = 0; i < 3; i++) {
                    CAL_CHISQUARE += ((observed_frequency_3d[i] - expected_frequency_3d[i]) *
                ...
                printf("\n\nThe sum of calculated chi-square statistics is: %f ", CAL_CHISQUARE);
                printf("\nThe tabulated value for chi-square is %f", TAB_CHISQUARE_3D);
